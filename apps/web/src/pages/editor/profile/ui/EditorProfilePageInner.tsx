...
import { ProfileCategoryOptionTabs } from '../ProfileCategoryOptionTabs';
...
export const EditorProfilePageInner = ({ initialPlaces }: { initialPlaces: IPlace[] }) => {
  ...
  return (
    <div className="flex h-full flex-col min-h-0">
      ...
      <ProfileCategoryOptionTabs value={category} onChange={setCategory} />
      ...
      <div className="flex-1 min-h-0 pt-6">
        ...
        <BottomSheet isOpen={open} onOpenChange={setOpen} height={500} peekHeight={72}>
          <div className="px-5 pb-6">
            <div className="flex flex-row justify-between pb-4 pt-5">
